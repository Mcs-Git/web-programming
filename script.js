let language = document.querySelectorAll(".drop_language");
...
const tab = [
    ` <header>
        ...
        <nav class="nav_bar">
            <p><a href="index.html" class="home">Accueil</a></p>
            <p><a href="#">A Propos</a></p>
            <p><a href="#">Nos Services</a></p>
            <p><a href="#">Contacts</a></p>
            <div class="language">
                <p><img src="/images/france.jpg" alt="france" class="france_flag"></p>
        ...
        <div class="menu_bar_mobile hide dropIn">
            <p><a href="index.html" class="">Accueil</a></p>
            <p><a href="#">A Propos</a></p>
            <p><a href="#">Nos Services</a></p>
            <p><a href="#">Contacts</a></p>
            <div class="language">
    ...
    <main>
        ...
        <section class="introduction">
            <div class="slider">
                <div class="slides">
                    ...
                    <img src="/images/1200.jpg" alt="plane">
                    <img src="/images/24177.jpg" alt="ship">
                    <img src="/images/pexels-tom-fisk-2226458.jpg" alt="ship">
                    <img src="/images/pexels-tom-fisk-3057960.jpg" alt="cargo">
                    <img src="/images/1200.jpg" alt="plane">
            ...
            <div class="intro">
                ...
                <p class="main_title">Commissionnaire en douane agree au Cameroun</p>
                <p class="main_text">Nous assurons les meilleurs couts et delais pour le dedouanement de vos marchandises jusqu'a la livraison.</p>
        ...
        <section class="below_introduction">
            <div class="feature_1 block-1 block-1-tablet">
                <div class="tasks">
                    <p class="tasks_question">Ce que l'on fait</p>
                    <p class="tasks_logo"><img src="/images/ship.svg" alt="ship" class="ship_logo"></p>
                </div>
                <p class="tasks_item">Solution de fret sur et fiable</p>
            </div>
            <div class="feature_1 block-1 block-2-tablet">
                <div class="task_1">
                    <p class="service_1">Douane et transit</p>
                    <p class="service_logo-1"><img src="/images/truck.svg" alt="truck" class="truck"></p>
                </div>
                <p class="service_text-1">Nous vous aidons avec toutes vos formalités douanières, nous facilitons également la circulations de vos marchandises jusqu’au pays destinataire.</p>
            </div>
            <div class="task_2 feature_1">
                <p class="service_2 logistic">Transport et Logistique</p>
                <p class="service_text-2">Nous garantissons l’acheminement de vos marchandises jusqu’à destination, en vous offrant une meilleure traçabilité de vos produits.</p>
            </div>
        </section>
        ...
        <section class="on_us">
            <p class="tasks_question"> Pourquoi Nous</p>
            <p class="on_us-title">Nous vous fournissons une gamme complète d’expert en formalité douanière</p>
            <p class="on_us-text">Notre équipe d’expert est là pour vous donner tous les conseils nécessaires sur tous vos soucis de dédouanement. Elle préconise:</p>
            <div class="task"><div class="delivered"><img src="/images/house.svg" alt="house" class="house"></div><p class="on_us-task">Livraison dans les délais</p></div>
            <div class="task"><div class="bill"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M64 64C28.7 64 0 92.7 0 128V384c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V128c0-35.3-28.7-64-64-64H64zm64 320H64V320c35.3 0 64 28.7 64 64zM64 192V128h64c0 35.3-28.7 64-64 64zM448 384c0-35.3 28.7-64 64-64v64H448zm64-192c-35.3 0-64-28.7-64-64h64v64zM288 160a96 96 0 1 1 0 192 96 96 0 1 1 0-192z"/></svg></div><p class="on_us-task">Devis adapté client</p></div>
        ...
        <section class="services">
            <p class="service_title">Nos Services</p>
            <div class="service_boxes">
                <div class="service_box">
                    <p class="servicebox_title-1">Service de conseil ET d’accompagnement</p>
                    <p class="servicebox_text-1">Vous souhaitez importer et/ou exporter mais vous ne savez pas comment vous y prendre ? Notre service conseil et accompagnement vous dira tout ce que vous voulez savoir.</p>
                </div>
                <div class="service_box">
                    <p class="servicebox_title-1">Service de livraison</p>
                    <p class="servicebox_text-1">Un service de livraison fiable et disponible en Afrique (Cameroun, Tchad, et Centrafrique)</p>
                </div>
            </div>
        ...
        <section class="team">
            <div class="team_Title"><p class="team_title">L'Equipe</p></div>
            <p class="team_subtitle">Rencontrer une equipe d'expert</p>
            <div class="team_members">
                <div class="member first">
                    <div class="member_role">
                        <p class="member_name">Alfred</p>
                        <p>Technicien Logistique</p>
                    </div>
                </div>
                ...
                <div class="member third">
                    <div class="member_role">
                        ...
                        <p>Contrôleur des normes et qualités</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="choice">
            <div class="backgrounds">
                ...
                <div class="second_background">
                    <p class="On_us">Pourquoi nous choisir</p>
                    <p class="second_background_title">Nous créons des opportunités pour que vous atteigniez votre potentiel</p>
                    <p class="second_background_text">Nous proposons une qualité de service orientée client, vous favorisant ainsi un gain de productivité et un gain financier en offrant </p>
                    <div class="services">
                        <div class="service opt-1"><div class="bill"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M64 64C28.7 64 0 92.7 0 128V384c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V128c0-35.3-28.7-64-64-64H64zm64 320H64V320c35.3 0 64 28.7 64 64zM64 192V128h64c0 35.3-28.7 64-64 64zM448 384c0-35.3 28.7-64 64-64v64H448zm64-192c-35.3 0-64-28.7-64-64h64v64zM288 160a96 96 0 1 1 0 192 96 96 0 1 1 0-192z"/></svg></div><p class="service_text">Devis adapté</p></div>
                        <div class="service opt-2"><div class="clock"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/></svg></div><p class="service_text">Livraison à temps</p></div>
                        <div class="service opt-3"><div class="delivered"><img src="/images/house.svg" alt="house" class="house"></div><p class="service_text">Suivi des livraisons</p></div>
                    </div>
                </div>
            </div>
        ...
        <section class="informations">
            <div class="end_informations">
                <div class="adresses">
                    ...
                    <p class="contact_text">Vous pouvez nous joindre pour toute autre information supplémentaire.</p>
                    ...
                    <div class="contacts_me">
                        ...
                        <div>
                            <p class="phone_name">Tel / Portable</p>
                    ...
                    <div class="contacts_me">
                        ...
                        <div class="meeting_time">
                            <p class="meeting">Lun-Ven 8h-18H</p>
                            <p>Sam 8h-13h</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="footer_items">
            ...
            <div class="foot_flex">
                <div class="contact_us">
                    ...
                    <div class="contacts_me">
                        <div class="position"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg></div>
                        <div class="meeting_time">
                            <p class="meeting">Cameroun, Yaoundé</p>
                            <p>Nkoabang</p>
                        </div>
                    </div>
                </div>
                <div class="navigation_links">
                    ...
                    <div class="social_medias">
                        ...
                        <div class="logo"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64h98.2V334.2H109.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H255V480H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64z"/></svg></div>
                        <div class="logo"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M416 32H31.9C14.3 32 0 46.5 0 64.3v383.4C0 465.5 14.3 480 31.9 480H416c17.6 0 32-14.5 32-32.3V64.3c0-17.8-14.4-32.3-32-32.3zM135.4 416H69V202.2h66.5V416zm-33.2-243c-21.3 0-38.5-17.3-38.5-38.5S80.9 96 102.2 96c21.2 0 38.5 17.3 38.5 38.5 0 21.3-17.2 38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <section class="informations">
                <div class="end_informations">
                    ...
                    <form action="#" class="formular">
                        ...
                        <div class="tel_number">
                            <label for="tel"></label>
                            <input type="text" id="tel" placeholder="Telephone number*" required>
                        </div>
                        <div class="town">
                            <label for="city"></label>
                        ...
                        <div class="comments">
                            <textarea name="comment" id="comments" placeholder="Leave a message"></textarea>
                        </div>
                        <div class="button">
...
function reapply (){
    const languages = document.querySelectorAll('.drop_language');
    languages.forEach(e => {e.addEventListener('click', change_language)})
}
...
language.forEach(e =>e.addEventListener("click",()=> 
        ...
        if (localStorage.getItem('language') == 'en'){
            document.querySelector("main").innerHTML  = tab[0];
            document.querySelector(".footer_delete").innerHTML  = ` `;
        } else {
            
            document.querySelector("main").innerHTML = tab[1];
            document.querySelector(".footer_delete").innerHTML  = `    <footer>
                                                                            <section class="footer_items">
                                                                                <div class="foot_background">
                                                                                    <div class="foot_logo"><img src="/images/logo_white.png" alt="logo"></div>
                                                                                </div>
